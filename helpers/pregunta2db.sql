...
(450, 80, 4, '2023-11-25 04:37:26'),
(451, 80, 2, '2023-11-25 04:43:39'),
(452, 80, 0, '2023-11-25 04:43:56'),
(453, 80, 8, '2023-11-25 04:44:27'),
(454, 80, 1, '2023-11-25 04:44:56'),
(455, 94, 1, '2023-11-25 04:50:58'),
(456, 94, 2, '2023-11-25 04:51:12'),
(457, 94, 2, '2023-11-25 04:51:28'),
(458, 93, 2, '2023-11-25 04:51:53'),
(459, 93, 4, '2023-11-25 04:52:14'),
(460, 12, 2, '2023-11-25 04:53:45'),
(461, 12, 2, '2023-11-25 04:53:54'),
(462, 12, 9, '2023-11-25 04:54:28');
...
=======
(82, 'Admin', '1998-09-01', 'No especificar', 1, -37.11248696198316600000, -56.85141338520986000000, 'admin@pregunta2.com.ar', 'Admin', NULL, 1, '56de15ff97c9bce1b769fc2c783bc834', '81dc9bdb52d04dc20036dbd8313ed055', '0', 0, 0, 0, '2023-11-25'),
(83, 'Editor', '1999-09-05', 'No especificar', 1, -32.95088252473996000000, -60.70188254502038000000, 'editor@pregunta2.com.ar', 'Editor', NULL, 2, 'a1d59b3bbdcc7dd1e221ad60e7b65395', '81dc9bdb52d04dc20036dbd8313ed055', '0', 0, 0, 0, '2023-11-25'),
>>>>>>> Stashed changes
...
--
-- Índices tabla `categoria`
--
ALTER TABLE `categoria`
  ADD PRIMARY KEY (`id`);

--
-- Indices tabla `estado_pregunta`
--
...
--
-- Indices tabla `usuario_pregunta`
--
...
--
--
-- AUTO_INCREMENT tabla `categoria`
--
ALTER TABLE `categoria`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT tabla `estado_pregunta`
--
ALTER TABLE `estado_pregunta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT tabla `pais`
--
ALTER TABLE `pais`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT tabla `partida`
--
ALTER TABLE `partida`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=463;

--
-- AUTO_INCREMENT tabla `pregunta`
--
ALTER TABLE `pregunta`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;

--
-- AUTO_INCREMENT tabla `rol`
--
ALTER TABLE `rol`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT tabla `usuario_pregunta`
--
ALTER TABLE `usuario_pregunta`
